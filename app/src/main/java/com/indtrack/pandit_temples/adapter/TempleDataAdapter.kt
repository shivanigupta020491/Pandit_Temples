...
import com.indtrack.pandit_temples.adapter.TempleDataAdapter.ItemViewHolder
import com.indtrack.pandit_temples.pojo.TemplePojo
import java.util.*

class TempleDataAdapter( var listdata: ArrayList<TemplePojo>, var checkString:String) : RecyclerView.Adapter<ItemViewHolder>() {
...
//        }
        ...
        itemViewHolder.topicText.text = listdata[position].name
        itemViewHolder.location.text = listdata[position].location
        itemViewHolder.activityName.text = listdata[position].activity
...
//        }
    ...
    class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var activityTextView: TextView
        var relativeL: RelativeLayout


        init {
            topicText = itemView.findViewById<View>(R.id.assignmentTopicName) as TextView
            location = itemView.findViewById<View>(R.id.locationNameText) as TextView
            dateText = itemView.findViewById<View>(R.id.dateText) as TextView
            activityName = itemView.findViewById<View>(R.id.activityText) as TextView
            locationTextView = itemView.findViewById<View>(R.id.locationTV) as TextView
            dateTextView = itemView.findViewById<View>(R.id.dateTV) as TextView
            activityTextView = itemView.findViewById<View>(R.id.activityTV) as TextView
