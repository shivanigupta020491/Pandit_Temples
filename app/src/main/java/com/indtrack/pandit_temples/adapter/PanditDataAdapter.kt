...
class PanditDataAdapter (var listdata: ArrayList<PanditPojo>) : RecyclerView.Adapter<PanditDataAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.pandit_list_item, parent, false)
...
//        }
        ...
        itemViewHolder.contactText.text = listdata[position].contactNo
        itemViewHolder.descText.text = listdata[position].description
        itemViewHolder.workText.text = listdata[position].work
...
//        }
    ...
    class ItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            contactText = itemView.findViewById<View>(R.id.contactNameText) as TextView
            workText = itemView.findViewById<View>(R.id.workText) as TextView
            descText = itemView.findViewById<View>(R.id.descText) as TextView
